...
TOKEN = '8951548698:AAHeQawi54IEatNwUALBr7Rim0RtrpEIaPM'
OWNER_ID = int(os.getenv('OWNER_ID', 8199894439))
ADMIN_ID = int(os.getenv('ADMIN_ID', 6964360406))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'aditya')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'aditya')
...
ADMIN_LIMIT = int(os.getenv('ADMIN_LIMIT', 9999))
